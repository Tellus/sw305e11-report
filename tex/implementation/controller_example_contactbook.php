...
class Contactbook extends GirafController
{
	...
	/**
	 * "list" is a reserved word in PHP, so we shadow the name
	 * and call the function through the fallback function instead.
	 **/
	...
	public function add($params = array())
	{
		...
		// Handle uploaded images. This is handled after message creation because we did not know the ID
		// beforehand.
		...
		echo "success"; // Magic return string to the AJAX handler.
	}
}