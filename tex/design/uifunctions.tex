...
In this section a list of functions, regarding the visual part of the system will be laid out. This is done to give a better understanding of the functions needed by GIRAFAdmin. The functions are grouped by an headline that should be a part of the GIRAFAdmin. However, not all functions were implemented due to limited time.  
\\
\\
Function types:
\begin{itemize}
