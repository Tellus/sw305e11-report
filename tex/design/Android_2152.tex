...
The client can pull a list of installed applications by creating a new new instance of the Android \emph{PackageManager} class and call the \emph{getInstalledApplications(int flags)} method \cite{AndDevel2}. 
