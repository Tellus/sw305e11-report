...
In our unit test we have used the php unit test framework SimpleTest, which meant that we only had to write the unit test cases and the specified test suite. First, what was tested will be listed and then a few examples will be shown. 
